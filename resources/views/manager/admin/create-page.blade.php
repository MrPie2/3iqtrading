 ...
 <div class="container-fluid">
     <div align="center" style="margin-top: 30px">
         ...
         <div class="col-md-7">
            ...
            <div class="form-group"><label>Cover_Photo</label><input type="text" class="form-control Cover_Photo"placeholder="https://www.3iqtrading.org/Resources/pic.jpg"></div>
...
var target=$('.target').val();
          $.ajax({
              url:"CreatePage.php",
              method:"POST",
              data:{Content:Content,link:link,page_name:page_name, Cover_Photo:Cover_Photo, 
              Description:Description, icon:icon, type:type,child_of:child_of, css:css,js:js, target:target
            },
