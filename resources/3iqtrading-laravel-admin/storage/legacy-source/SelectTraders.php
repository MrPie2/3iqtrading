...
$sql="SELECT * FROM copy_traders";
$query=mysqli_query($Conn, $sql);
$output='<div class="panel-group" id="accordion">';
while($row=mysqli_fetch_array($query, MYSQLI_ASSOC)){

$output.='
<div class="card card-body"> <div class="panel-heading"> <h5 class="panel-title" <a   href="#collapse'.$row['id'].'"><img src="'.$row['profile_photo'].'" style="width: 50px; height: 50px"/> '.$row['name'].' <span style="font-size: 10pt">'.$row['username'].'</span>        </a>       <small>
<a class="pull-right DeleteTrader" href="#" id="'.$row['id'].'">Delete</a></small></h5>
