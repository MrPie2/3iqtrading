...
<body>
 <div class="container-fluid">
     <div align="center" style="margin-top: 30px"><h1>Page Maker <br><small style="font-size: 12pt">Use this section to create or modify existing pages on you site</small></h1></div>
	...
	<textarea id="js" class="form-control js" rows="10"> </textarea> 
     ...
     <div class="col-md-5">
         <div style="padding: 20px; text-align: center;"><button class="btn btn-lg btn-warning PreviewEdit">Preview</button>
             ...
             <button class="btn btn-lg btn-primary Upload"id="<?php echo $row['id']; ?>" style="margin-left: 20px">Upload</button></div>
